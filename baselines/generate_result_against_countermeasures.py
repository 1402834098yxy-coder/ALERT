...
def generate_result(dataset,countermeasure,kws_uni_size):
    with open(f"result/test_against_countermeasures/Re_{dataset}_{countermeasure}_{kws_uni_size}.json","r") as f:
        data = json.load(f)
        ...
        for key in acc_keys:
            ...
            with open(f"final_result/test_against_countermeasures/{method_name}_{dataset}_{countermeasure}_{kws_uni_size}.txt", 'w') as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--countermeasure", type=str, default="padding_linear")
    # parser.add_argument("--test_times", type=int, default=5)
    args = parser.parse_args()
    generate_result(args.dataset, args.countermeasure, args.kws_uni_size)
