...
TASK='test_large_keyword_wiki'
DATASETS=('wiki_3000' 'wiki_5000' 'wiki_7000')
FACTOR='1'
GPU_NUM="0"
declare -A FEATURE_NUMS
FEATURE_NUMS['wiki_3000']=3000
FEATURE_NUMS['wiki_5000']=5000
FEATURE_NUMS['wiki_7000']=7000
...
do
    ...
    FEATURE_NUM=${FEATURE_NUMS[$DATASET]}
...
do
    ...
    LOG_TRAIN_FILE="${LOG_BASE_DIR}ALERT_${DATASET}_${EXPERIMENT_SETTING}_${candidate}_${COUNTERMEASURES}_${FACTOR}_${FPBP_DEL_PERCENTAGE}_${run}_train.log"
    LOG_TEST_FILE="${LOG_BASE_DIR}ALERT_${DATASET}_${EXPERIMENT_SETTING}_${candidate}_${COUNTERMEASURES}_${FACTOR}_${FPBP_DEL_PERCENTAGE}_${run}_test.log"
...
for FPBP_DEL_PERCENTAGE in "${FPBP_DEL_PERCENTAGES[@]}"
do
  LOG_BASE_FILE="${PROJECT_ROOT}/result/${DATASET}/${EXPERIMENT_SETTING}/ALERT_${DATASET}_${EXPERIMENT_SETTING}_${candidate}_${COUNTERMEASURES}_${FACTOR}_${FPBP_DEL_PERCENTAGE}_"

     
PART='test'
OUTPUT_DIR="${OUTPUT_folder}/ALERT_${DATASET}_${EXPERIMENT_SETTING}_${candidate}_${COUNTERMEASURES}_${FACTOR}_${FPBP_DEL_PERCENTAGE}_${PART}_"
...
python ${PROJECT_ROOT}/baselines/test_large_keyword_wiki.py --dataset wiki --kws_uni_size 7000 --repeat_time $RUN_TIME --refspeed 6500

python ${PROJECT_ROOT}/baselines/test_large_keyword_wiki.py --dataset wiki --kws_uni_size 5000 --repeat_time $RUN_TIME --refspeed 4500

python ${PROJECT_ROOT}/baselines/test_large_keyword_wiki.py --dataset wiki --kws_uni_size 3000 --repeat_time $RUN_TIME --refspeed 2500
