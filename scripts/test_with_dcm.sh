...
do
    ...
    LOG_TRAIN_FILE="${LOG_BASE_DIR}ALERT_${DATASET}_${EXPERIMENT_SETTING}_${candidate}_${COUNTERMEASURES}_${FACTOR}_${FPBP_DEL_PERCENTAGE}_dcm_1_${run}_train.log"
    LOG_TEST_FILE="${LOG_BASE_DIR}ALERT_${DATASET}_${EXPERIMENT_SETTING}_${candidate}_${COUNTERMEASURES}_${FACTOR}_${FPBP_DEL_PERCENTAGE}_dcm_1_${run}_test.log"
...
for candidate in "${candidates[@]}"
do
  LOG_BASE_FILE="${PROJECT_ROOT}/result/${DATASET}/${EXPERIMENT_SETTING}/ALERT_${DATASET}_${EXPERIMENT_SETTING}_${candidate}_${COUNTERMEASURES}_${FACTOR}_${FPBP_DEL_PERCENTAGE}_dcm_1_"

        
PART='test'
OUTPUT_DIR="${OUTPUT_folder}/ALERT_${DATASET}_${EXPERIMENT_SETTING}_${candidate}_dcm_1_${PART}_"
