...
cd "${PROJECT_ROOT}"
TASK='test_against_countermeasures'
...
COUNTERMEASURES=("padding_linear" "padding_seal" "padding_cluster")
ADP=false
...
do
    OUTPUT_DIR_NORM_train="${BASE_OUTPUT_DIR_NORM_train}_${candidate}_${COUNTERMEASURE}_${FACTOR}_${FPBP_DEL_PERCENTAGE}.pkl"  
    OUTPUT_DIR_train="${BASE_OUTPUT_DIR_train}_${candidate}_${COUNTERMEASURE}_${FACTOR}_${FPBP_DEL_PERCENTAGE}.pkl"
    OUTPUT_DIR_NORM_test="${BASE_OUTPUT_DIR_NORM_test}_${candidate}_${COUNTERMEASURE}_${FACTOR}_${FPBP_DEL_PERCENTAGE}.pkl"
    OUTPUT_DIR_test="${BASE_OUTPUT_DIR_test}_${candidate}_${COUNTERMEASURE}_${FACTOR}_${FPBP_DEL_PERCENTAGE}.pkl"


    INPUT_DIR="${BASE_INPUT_DIR}${candidate}/train/${COUNTERMEASURE}"
    ...
    INPUT_DIR_test="${BASE_INPUT_DIR}${candidate}/test/${COUNTERMEASURE}"
...
TRAIN_INPUT="${BASE_OUTPUT_DIR_train}_${candidate}_${COUNTERMEASURE}_${FACTOR}_${FPBP_DEL_PERCENTAGE}.pkl"
TEST_INPUT="${BASE_OUTPUT_DIR_test}_${candidate}_${COUNTERMEASURE}_${FACTOR}_${FPBP_DEL_PERCENTAGE}.pkl"
    NORM_TRAIN_INPUT="${BASE_OUTPUT_DIR_NORM_train}_${candidate}_${COUNTERMEASURE}_${FACTOR}_${FPBP_DEL_PERCENTAGE}.pkl"
    NORM_TEST_INPUT="${BASE_OUTPUT_DIR_NORM_test}_${candidate}_${COUNTERMEASURE}_${FACTOR}_${FPBP_DEL_PERCENTAGE}.pkl"
    LOG_TRAIN_FILE="${LOG_BASE_DIR}ALERT_${DATASET}_${EXPERIMENT_SETTING}_${candidate}_${COUNTERMEASURE}_${FACTOR}_${FPBP_DEL_PERCENTAGE}_${run}_train.log"
    LOG_TEST_FILE="${LOG_BASE_DIR}ALERT_${DATASET}_${EXPERIMENT_SETTING}_${candidate}_${COUNTERMEASURE}_${FACTOR}_${FPBP_DEL_PERCENTAGE}_${run}_test.log"
    MODEL_MAIN_DIR="${PROJECT_ROOT}/model/${DATASET}/${EXPERIMENT_SETTING}/main/${candidate}/${COUNTERMEASURE}/${FACTOR}/${FPBP_DEL_PERCENTAGE}_${run}"
    MODEL_PCA_DIR="${PROJECT_ROOT}/model/${DATASET}/${EXPERIMENT_SETTING}/pca/${candidate}/${COUNTERMEASURE}/${FACTOR}/${FPBP_DEL_PERCENTAGE}_${run}"
...
for COUNTERMEASURE in "${COUNTERMEASURES[@]}"
do
LOG_BASE_FILE="${PROJECT_ROOT}/result/${DATASET}/${EXPERIMENT_SETTING}/ALERT_${DATASET}_${EXPERIMENT_SETTING}_${candidate}_${COUNTERMEASURE}_${FACTOR}_${FPBP_DEL_PERCENTAGE}_"


PART='test'
        OUTPUT_DIR="${OUTPUT_folder}/ALERT_${DATASET}_${EXPERIMENT_SETTING}_${candidate}_${COUNTERMEASURE}_${PART}_"
...
for COUNTERMEASURE in "${COUNTERMEASURES[@]}"; do
    for DATASET in "${DATASETS[@]}"; do
        python ${PROJECT_ROOT}/baselines/test_against_countermeasure.py \
            --countermeasure "$COUNTERMEASURE" \
            --test_times "$RUN_TIME" \
            --kws_uni_size "$FEATURE_NUM" \
            --datasets "$DATASET" \
            --kws_extraction "$KWS_EXTRACTION"

        python ${PROJECT_ROOT}/baselines/generate_test_against_countermeasures.py \
            --countermeasure "$COUNTERMEASURE" \
            --test_times "$RUN_TIME" \
            --kws_uni_size "$FEATURE_NUM" \
            --datasets "$DATASET" \
        ...
        python ${PROJECT_ROOT}/baselines/generate_result_against_countermeasures.py \
            --countermeasure "$COUNTERMEASURE" \
            --kws_uni_size "$FEATURE_NUM" \
            --dataset "$DATASET" 
    done
