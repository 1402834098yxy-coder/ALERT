...
END_PERCENTAGE=50 
STEP_PERCENTAGE=10    
FPBP_DEL_PERCENTAGES=(0 0.05 0.10 0.15 0.20 0.25 0.30 0.35 0.40 0.45 0.50)
...
OUTPUT_DIR="${OUTPUT_folder}/ALERT_${DATASET}_${EXPERIMENT_SETTING}_${candidate}_${FPBP_DEL_PERCENTAGE}_${PART}_"
# mkdir -p $OUTPUT_DIR
